...
class Citrus_Integration_Block_Adminhtml_Citrusintegration_Ad_Request extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $pageType = $fieldset->addField(
            'pageType', 'select', array(
        ...
        $searchTerm = $fieldset->addField(
            'searchTerm', 'text', array(
        ...
        $productFilter = $fieldset->addField(
            'productFilter', 'text', array(
        ...
        $maxNumberOfAds = $fieldset->addField(
            'maxNumberOfAds', 'hidden', array(
        ...
        $fieldset->addField(
            'is_banner', 'hidden', array(
            'label'     => Mage::helper('citrusintegration')->__('Is Banner'),
            'name'      => 'is_banner',
            'value'     => $is_banner
            )
        );
        $bannerSlotIds = $fieldset->addField(
            'bannerSlotIds', 'text', array(
