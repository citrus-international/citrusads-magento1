...
class Citrus_Integration_Block_Adminhtml_Citrusintegration_Ad_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $discountFieldset = $form->addFieldset(
            'discount_fieldset', array(
            'legend'    => Mage::helper('checkout')->__('Discount Information'),
            'class'     => 'fieldset-wide',
            )
        );
        $discountFieldset->addField(
            'name', 'text', array(
            'name'      => 'amount',
        ...
        $bannerFieldset = $form->addFieldset(
            'banner_fieldset', array(
            'legend'    => Mage::helper('checkout')->__('Banner Information'),
            'class'     => 'fieldset-wide',
            )
        );
        $bannerFieldset->addField(
            'name', 'text', array(
            'name'      => 'name',
